...
const Detail = () => {
  ...
  useEffect(() => {
    api.get(`collectPoints/${routeParams.point_id}`).then(response => {
  ...
  function handleWhatsapp(){
    Linking.openURL(`whatsapp://send?phone=${data.collectPoint.whatsapp}&text=Olá! quero participar na coleta seletiva :)`)
  }

  if(!data.collectPoint) return null;
